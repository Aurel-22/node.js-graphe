/**
 * Crée un graphe de 50 000 nœuds avec une structure multi-communautés réaliste.
 * 
 * Structure :
 * - 20 communautés de 2 500 nœuds chacune
 * - Connexions denses INTRA-communauté (chaque nœud a 3-8 voisins locaux)
 * - Ponts INTER-communautés (hubs qui relient les clusters)
 * - ~250 000 arêtes au total (~5 par nœud en moyenne)
 * 
...
const GRAPH_ID = 'community_50k';
const NODE_COUNT = 50_000;
const COMMUNITY_COUNT = 20;
const NODES_PER_COMMUNITY = NODE_COUNT / COMMUNITY_COUNT; // 2500
