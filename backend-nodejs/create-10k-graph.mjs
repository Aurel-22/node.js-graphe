/**
 * Crée un graphe de 10 000 nœuds avec une structure multi-communautés réaliste.
 * 
 * Structure :
 * - 10 communautés de 1 000 nœuds chacune
 * - Connexions denses INTRA-communauté (chaque nœud a 3-8 voisins locaux)
 * - Ponts INTER-communautés (hubs qui relient les clusters)
 * - ~50 000 arêtes au total (~5 par nœud en moyenne)
 * 
...
const GRAPH_ID = 'community_10k';
const NODE_COUNT = 10_000;
const COMMUNITY_COUNT = 10;
const NODES_PER_COMMUNITY = NODE_COUNT / COMMUNITY_COUNT; // 1000
