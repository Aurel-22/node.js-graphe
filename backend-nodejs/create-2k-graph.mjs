/**
 * Crée un graphe de 2 000 nœuds avec une structure multi-communautés réaliste.
 * 
 * Structure :
 * - 5 communautés de ~400 nœuds chacune
 * - Connexions denses INTRA-communauté (chaque nœud a 3-8 voisins locaux)
 * - Ponts INTER-communautés (hubs qui relient les clusters)
 * - ~10 000 arêtes au total (~5 par nœud en moyenne)
 * 
 * Utilise UNWIND pour des batch inserts rapides (2 requêtes au lieu de 2000+)
 */
...
const GRAPH_ID = 'community_2k';
const NODE_COUNT = 2_000;
const COMMUNITY_COUNT = 5;
const NODES_PER_COMMUNITY = NODE_COUNT / COMMUNITY_COUNT; // 400
